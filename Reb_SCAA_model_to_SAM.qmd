...
Natural mortality was assumed as `r M` for all 

## Dummy datasets

These dummy datasets contain only 0s or 1s encompassing the ages and years in the other datasets. They are used in the model where datasets with only 0s or 1s are required. 
